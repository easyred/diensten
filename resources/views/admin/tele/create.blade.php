...
@section('title', 'Nieuwe Tele Record')

@section('page-title', 'Nieuwe Tele Record')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Nieuwe Tele Record Aanmaken</h4>
                    ...
                    <form method="POST" action="{{ route('admin.tele.store') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="contacted_date" value="{{ old('contacted_date', date('Y-m-d')) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="message" rows="5" 
                                          ...
                                          placeholder="Voer uw bericht in...">{{ old('message') }}</textarea>
                                @error('message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
